...
@Component({
  selector: 'app-sub-dispatched-stock',
  templateUrl: './sub-dispatched-stock.component.html',
  styleUrls: ['./sub-dispatched-stock.component.scss']
})
export class SubDispatchedStockComponent {
