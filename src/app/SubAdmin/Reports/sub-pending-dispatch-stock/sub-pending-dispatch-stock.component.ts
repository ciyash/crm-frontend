...
@Component({
  selector: 'app-sub-pending-dispatch-stock',
  templateUrl: './sub-pending-dispatch-stock.component.html',
  styleUrls: ['./sub-pending-dispatch-stock.component.scss']
})
export class SubPendingDispatchStockComponent {
