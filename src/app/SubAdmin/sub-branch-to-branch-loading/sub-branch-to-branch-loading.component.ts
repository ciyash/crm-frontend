...
@Component({
  selector: 'app-sub-branch-to-branch-loading',
  templateUrl: './sub-branch-to-branch-loading.component.html',
  styleUrls: ['./sub-branch-to-branch-loading.component.scss']
})
export class SubBranchToBranchLoadingComponent {
