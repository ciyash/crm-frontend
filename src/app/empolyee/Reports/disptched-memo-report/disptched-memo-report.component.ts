...
@Component({
  selector: 'app-disptched-memo-report',
  templateUrl: './disptched-memo-report.component.html',
  styleUrls: ['./disptched-memo-report.component.scss']
})
export class DisptchedMemoReportComponent {
